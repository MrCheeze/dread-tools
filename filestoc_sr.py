...
f = open('samusreturns_files.toc','rb')
...
for filename in ['filestoc_sr.txt']:
    f = open(filename)
    for line in f:
        f4.write(line)
...
assert crc32('actors/characters/arachnus/animations/death.bcskla') in needed_hashes
assert crc32('actors/characters/arachnus/animations/death.bcskla') in hashes

#for filename in glob.glob('*.txt'):
for filename in ['filestoc.txt','filestoc_sr.txt','customstrings.txt']:
...
f = open('samusreturns_files.toc','rb')
f2 = open('filestoc_sr.txt','w')
f5 = open('filestoc_sr_sizesorted.txt','w')


f3 = open('unknowns_sr.txt','w')
