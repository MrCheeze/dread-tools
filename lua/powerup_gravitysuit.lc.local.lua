...
-- Command line: lua/powerup_gravitysuit.lc.local 

-- params : ...
-- function num : 0
-- DECOMPILER ERROR at PC2: Confused about usage of register: R0 in 'UnsetPending'

PowerUpGravitySuit.main = function()
  -- function num : 0_0
end
...
PowerUpGravitySuit.OnPickedUp = function(l_2_0)
  -- function num : 0_1
  (Game.PlayEntitySoundContinueOnDead)("generic/obtencion.wav", l_2_0.sName, 1, 500, 4000, 1)
  local l_2_1 = (Game.GetActor)("cutsceneplayer_31")
  ...
  PowerUpGravitySuit.Self = l_2_0
end

-- DECOMPILER ERROR at PC10: Confused about usage of register: R0 in 'UnsetPending'

PowerUpGravitySuit.ShowMessage = function()
  -- function num : 0_2
...
PowerUpGravitySuit.ChangeSuit = function()
  -- function num : 0_3
...
PowerUpGravitySuit.OnItemEnd = function(l_5_0)
  -- function num : 0_4
end
